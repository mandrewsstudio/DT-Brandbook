<?php
/**
 * Title: Main Header (Logo and navigation left, search right)
 * Slug: begnas/header-2
 * Categories: header
...
<div class="wp-block-group alignfull has-gray-0-background-color has-background"
    ...
    <div class="wp-block-group alignwide"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
        ...
        <div class="wp-block-group">
            <!-- wp:search {"label":"Search","showLabel":false,"widthUnit":"%","buttonText":"Search","buttonPosition":"button-only","buttonUseIcon":true,"isSearchFieldHidden":true,"style":{"border":{"radius":"4px"}},"borderColor":"gray-300","fontSize":"x-small"} /-->
        </div>
        <!-- /wp:group -->
    </div>
    <!-- /wp:group -->
